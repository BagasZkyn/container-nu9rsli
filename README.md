...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-nu9rsli.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-nu9rsli.containers.anotherwebservice.com/
...
```
git clone git@github.com:BagasZkyn/container-nu9rsli.git
cd container-nu9rsli
```
...
```
docker attach container-nu9rsli
```
